		...
		public:
			...
			*/
			...
			/**
				...
				la validit�. Il rovescio della medaglia � ovviamente la
				larghezza di banda sprecata per implementare tale meccanismo.
				In caso di errore (ad es. nessuno dei keepalives trasmessi �
				stato riscontrato) verr� notificato un evento FD_CLOSE
			...
			*/
			...
			/**
				...
				quando � disabilitata (il suo valore � false) tale algoritmo �
				abilitato.
				L'algoritmo di Nagle � usato per ridurre il traffico della rete
			...
			*/
			...
			/**
				Eliminata perch� la readLines � una read.
