...
TimesForMeeting1:: TimesForMeeting1 (void): Times ()
...
TimesForMeeting1:: ~TimesForMeeting1 (void)
...
/*
TimesForMeeting1:: TimesForMeeting1 (const TimesForMeeting1 &t)
...
Error TimesForMeeting1:: handleTimeOut (void)

{
	...
	#ifdef WIN32
		if ((errFileIO = FileIO:: open ("./appointment.txt",
	...
	if ((errFileIO = FileIO:: writeChars (iFileDescriptor,
		"Time out for meeting 1: ",
		strlen ("Time out for meeting 1: "),
