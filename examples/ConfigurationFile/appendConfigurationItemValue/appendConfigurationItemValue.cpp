...

{
	...
	if ((errAppendItemValue = cfConfiguration. appendItemValue (
		pSectionName, pItemName, pItemValue)) != errNoError)
	{
		std:: cerr << (const char *) errAppendItemValue << std:: endl;
